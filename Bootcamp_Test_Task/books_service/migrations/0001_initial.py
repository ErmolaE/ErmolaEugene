# Generated by Django 4.0 on 2023-03-25 10:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ManyToManyField(to='books_service.Author')),
                ('genre', models.ManyToManyField(help_text='Select a genre for this book', to='books_service.Genre')),
                ('language', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='books_service.language')),
            ],
        ),
    ]
